...
int print0x(unsigned char *code) {
    int opbytes = 1;
...
int print1x(unsigned char *code) {
    int opbytes = 1;
...
int print2x(unsigned char *code) {
    int opbytes = 1;
...
int print3x(unsigned char *code) {
    int opbytes = 1;
...
int print4x(unsigned char *code) {
    int opbytes = 1;
...
int print5x(unsigned char *code) {
    int opbytes = 1;
...
int print6x(unsigned char *code) {
    int opbytes = 1;
...
int print7x(unsigned char *code) {
    int opbytes = 1;
...
int print8x(unsigned char *code) {
    int opbytes = 1;
...
int print9x(unsigned char *code) {
    int opbytes = 1;
...
int printax(unsigned char *code) {
    int opbytes = 1;
...
int printbx(unsigned char *code) {
    int opbytes = 1;
...
int printcx(unsigned char *code) {
    int opbytes = 1;
...
int printdx(unsigned char *code) {
    int opbytes = 1;
...
int printex(unsigned char *code) {
    int opbytes = 1;
...
int printfx(unsigned char *code) {
    int opbytes = 1;
